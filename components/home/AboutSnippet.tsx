        ...
        <div className="grid md:grid-cols-2 gap-16 items-center">
          ...
          >
            ...
            <p className="text-gray-light leading-relaxed mb-6">
              עידן חולי הוא אחד הדמויות הבולטות בתחום הנדל״ן באזור רמת השרון ותל אביב.
              עם 20 שנות ניסיון בשוק הנדל״ן המקומי, עידן מביא עמו הבנה עמוקה של המגמות,
              הזדמנויות ייחודיות, ויכולת לנהל עסקאות מורכבות.
            </p>
            <p className="text-gray-light leading-relaxed mb-8">
              גישתו מבוססת על שקיפות מלאה, יצירתיות בפתרון אתגרים, ונחישות לספק תוצאות.
              בין אם אתם מוכרים, קונים, משכירים או מחפשים הזדמנות השקעה — עידן כאן עבורכם.
            </p>
